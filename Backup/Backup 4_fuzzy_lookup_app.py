...
class FuzzyMatcherApp:
    def __init__(self, master):
        ...
        self.label = Label(master, text="Welcome to the Fuzzy Lookup App", font=("Helvetica", 16, "bold"), justify='center')
        self.label.pack(pady=(15, 5), anchor='center')
        ...
        self.footer = Label(master, text="Developed by Christian G. — June 16, 2025 • Version 1.2", font=("Helvetica", 9, "italic"))
