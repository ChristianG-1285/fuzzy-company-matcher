...
from tkinter import Tk, Label, Button, filedialog, messagebox, ttk, StringVar, Entry, Frame, Scrollbar
import chardet
import os
import threading
import time
...
class FuzzyMatcherApp:
    ...
    def show_results(self):
        ...
        self.tree = ttk.Treeview(self.tree_container, yscrollcommand=vsb.set)
