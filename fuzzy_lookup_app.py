...
class FuzzyMatcherApp:
    def __init__(self, master):
        ...
        self.label = Label(master, text="Welcome to the Fuzzy Lookup App", font=("Helvetica", 16, "bold"), justify='center', bg='#ffffff', fg='#003366')
        self.label.pack(pady=(15, 5))

        self.sub_label = Label(master, text="\nCompare two company lists and export reviewed matches.", font=("Helvetica", 13), justify='center', bg='#ffffff', fg='#000000')
        ...
        self.file1_label = Label(master, text="File 1: Not selected", font=("Helvetica", 10), bg='#ffffff')
        ...
        self.file2_label = Label(master, text="File 2: Not selected", font=("Helvetica", 10), bg='#ffffff')
        ...
        self.search_entry = Entry(master, textvariable=self.search_var, fg='gray')
        ...
        self.progress_label = Label(master, text="", bg='#ffffff')
        self.progress_label.pack(pady=5)

        self.progressbar = ttk.Progressbar(master, orient="horizontal", mode="determinate", length=300)

        self.footer = Label(master, text="Developed by Christian G. — June 16, 2025 • Version 1.2", font=("Helvetica", 9, "italic"), bg='#ffffff', fg='#666666')
    ...
    def compare_files(self):
        ...
        self.progress_label.config(text=f"Done! Checked {total} items in {total_time} seconds.")
    ...
    def show_results(self):
        ...
        for idx, col in enumerate(self.results_df.columns):
            self.tree.heading(col, text=col)
            width = 200 if idx < 4 else 160
    ...
    def clear_placeholder(self, event):
        if self.search_entry.get() == "Type to filter results...":
            self.search_entry.delete(0, 'end')
